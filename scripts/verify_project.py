...
def main() -> int:
    required = [
        ...
        "docs/v1.0-source-release-candidate.md",
        "model_harness/agent_bridge.py",
        "model_harness/conversation_actions.py",
        "model_harness/conversation_payloads.py",
        "model_harness/conversation_stream.py",
        "model_harness/multi_agent.py",
        "model_harness/object_refs.py",
        "model_harness/synthesis_evidence.py",
        ...
        "model_harness/resource_feasibility.py",
        "model_harness/feasibility_store.py",
        ...
        "model_harness/web/conversation-view.js",
        "model_harness/web/interaction-shell.js",
        "model_harness/web/visual-system.css",
        "integrations/deepseek-harness/package.json",
        "integrations/deepseek-harness/package-lock.json",
        ...
        "scripts/verify_v10_rc.py",
        "acceptance/v0.7-gates.json",
        "acceptance/v1.0-gates.json",
        "acceptance/v1.0-report.schema.json",
        ...
        "tests/test_cli_installation.py",
        "tests/test_feasibility_store.py",
        "tests/test_model_binding_workspace.py",
        "tests/test_model_source_api.py",
        "tests/test_model_source_providers.py",
        "tests/test_model_source_store.py",
        "tests/test_release_metadata.py",
        "tests/test_conversation_actions.py",
        "tests/test_conversation_payloads.py",
        "tests/test_conversation_stream.py",
        "tests/test_multi_agent_runtime.py",
        "tests/test_object_refs.py",
        "tests/test_start_conversation_harness.py",
        "tests/test_studio_start_cli.py",
        "tests/test_synthesis_evidence.py",
        "tests/test_repository_analysis.py",
        "tests/test_repository_analysis_store.py",
        "tests/test_resource_feasibility.py",
        "tests/test_training_plans.py",
        "tests/test_verify_v09_l1_live.py",
        "tests/test_verify_v10_rc.py",
    ]
